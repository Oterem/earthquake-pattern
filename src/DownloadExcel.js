...
export default ({fullData, buttonTitle,isClustered}) => {

    const colors = ["FFFFFF00","FFCCEEFF","FFF86B00","FF00FF00","FFFF0000","cd6be0"];
    ...
    useEffect(()=>{
        ...
        a && a.forEach((cluster,index)=>{
            ...
            children && children.forEach(child=>{
                delete child._id;
                const childRowArray = makeExcelRowArray(child,colors[colorIndex]);
    ...
    const makeExcelRowArray = (obj,color) =>{
        ...
        return (
                <div >
                    <ExcelFile  element={<Button variant="contained" color="primary" style={{paddingRight:10}}>{buttonTitle}</Button>}>
